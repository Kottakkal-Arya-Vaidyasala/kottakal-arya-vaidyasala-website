...
export default function ParallaxImage({
  ...
  const scale = useTransform(
    scrollYProgress,
    [0, 0.5, 1],
    [1, zoom ? 1.08 : 1, zoom ? 1.12 : 1]
  );

  const overlayGradient = {
    none: "",
    bottom:
      "bg-gradient-to-t from-brand-dark/70 via-brand-dark/20 to-transparent",
  ...
  return (
    ...
    >
      ...
      {overlay !== "none" && (
        <div
          className={cn("absolute inset-0 z-[1]", overlayGradient[overlay])}
        />
      )}
