  ...
  return (
    <div className="fixed right-6 bottom-6 z-50 flex items-end gap-3">
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="glass-light max-w-[200px] rounded-lg px-4 py-2.5 shadow-xl"
          >
            <p className="text-brand-dark text-xs leading-snug font-semibold">
              Chat with us on WhatsApp
            </p>
            <p className="text-brand-grey mt-0.5 text-[10px]">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="group relative z-50 flex h-10 w-10 items-center justify-center outline-none md:h-14 md:w-14"
      >
        {/* Icon Container */}
        <div className="relative h-full w-full transition-all duration-300 group-hover:-translate-y-1 group-hover:scale-105">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            className="h-full w-full drop-shadow-[0_4px_12px_rgba(37,211,102,0.4)] group-hover:drop-shadow-[0_8px_20px_rgba(37,211,102,0.6)]"
          >
            <path
              fill="#25D366"
              d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-5.46-4.45-9.91-9.91-9.91z"
            />
            <path
              fill="#FFF"
              d="M16.35 14.26c-.24-.12-1.4-.69-1.62-.77-.22-.08-.38-.12-.54.12-.16.24-.61.77-.75.93-.14.16-.28.18-.52.06-.24-.12-1-.37-1.9-1.18-.7-.63-1.18-1.41-1.32-1.65-.14-.24-.01-.37.11-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.54-1.3-.74-1.78-.19-.47-.39-.41-.54-.41-.14 0-.3 0-.46 0-.16 0-.42.06-.64.3-.22.24-.85.83-.85 2.03 0 1.2.87 2.36.99 2.52.12.16 1.72 2.62 4.17 3.68.58.25 1.03.4 1.38.51.58.18 1.11.16 1.53.1.47-.07 1.4-.57 1.6-1.12.2-.55.2-.1.14-.11z"
            />
          </svg>
        </div>
      </motion.a>
