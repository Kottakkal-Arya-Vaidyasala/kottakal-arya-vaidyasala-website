...
const servicesData = [
  // Body Scrubs & Wraps
  { id: "scrub-mud", category: "Body Scrubs & Wraps", title: "Aromatic moisturizing mud wrap", duration: "60 min", image: "/images/treatments/abhayangam.png", description: "Deeply hydrate and nourish your skin with our aromatic mud wrap." },
  ...
  { id: "facial-herbal", category: "Our Facials - Shine Bright", title: "Herbal Facial", duration: "60 min", image: "/images/treatments/herbal-facial.png", description: "Restore your natural glow with our signature herbal facial." },
  ...
  { id: "mind-shirobhyangam", category: "Ease Your Mind", title: "Shirobhyangam (Indian head massage)", duration: "30 min", image: "/images/treatments/abhayangam.png", description: "A deeply calming head massage that relieves stress and improves sleep." },
  ...
  // Our Programs
  { id: "prog-panchakarma", category: "Our Programs", title: "Panchakarma", duration: "Custom", image: "/images/treatments/panchakarma1.png", description: "The ultimate Ayurvedic detoxification and purification therapy." },
  ...
  { id: "prog-rejuvenation", category: "Our Programs", title: "Rejuvenation", duration: "Custom", image: "/images/treatments/abhayangam.png", description: "Rasayana therapies to slow aging and boost immunity." },
  ...
  // Ayurveda Therapies
  { id: "ayr-abhyangam", category: "Ayurveda Therapies", title: "Abhyangam", duration: "60 min", image: "/images/treatments/shirodhara.png", description: "Deeply nourishing whole-body warm oil massage." },
  ...
  { id: "ayr-udvarthnam", category: "Ayurveda Therapies", title: "Udvarthnam (Herbal powder massage)", duration: "60 min", image: "/images/treatments/abhayangam.png", description: "Invigorating dry herbal powder massage for weight management." },
  ...
  { id: "ayr-prishta", category: "Ayurveda Therapies", title: "Prishta vasti", duration: "60 min", image: "/images/treatments/abhayangam.png", description: "Specialized oil pooling therapy for the entire back." },
  ...
  { id: "ayr-thalapothichil", category: "Ayurveda Therapies", title: "Thalapothichil", duration: "60 min", image: "/images/treatments/abhayangam.png", description: "Cooling herbal paste applied to the head for stress relief." },
  ...
  { id: "well-prenatal", category: "Our Wellness Treatments", title: "Prenatal and Postnatal Care", duration: "Custom", image: "/images/treatments/abhayangam.png", description: "Soothing sessions dedicated to maternal well-being." },
                  ...
                  <ul className="space-y-4">
                    {["Doctors consultation", "Ayurveda therapies", "Dietary Plans", "Lifestyle modification advices"].map((feature, i) => (
                      <li key={i} className="flex items-center gap-3 group cursor-default">
                        <div className="w-8 h-8 rounded-full bg-brand-primary/5 flex items-center justify-center shrink-0 group-hover:bg-brand-primary group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                          <svg className="w-4 h-4 text-brand-primary group-hover:text-brand-gold transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <span className="text-gray-800 font-medium group-hover:text-brand-primary transition-colors duration-300">{feature}</span>
                      </li>
                    ))}
                  </ul>
                </div>
