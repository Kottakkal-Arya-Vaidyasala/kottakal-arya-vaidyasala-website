        ...
        <Container className="relative z-10 text-center">
          <AnimatedReveal direction="up" delay={100}>
            <h1
              ...
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl xl:text-6xl font-heading font-bold text-white whitespace-normal sm:whitespace-nowrap tracking-wide mb-0 px-4 leading-tight"
            >
              Heal naturally.{" "}
      ...
      <section id="offerings" className="pt-12 pb-24 bg-white relative">
        ...
        <Container className="relative z-10">
            ...
            <div className="bg-brand-cream/30 rounded-3xl p-6 sm:p-8 md:p-10 border border-brand-gold/20 shadow-sm relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row gap-10 items-center justify-between">
                <div className="w-full lg:w-1/2">
                  ...
                  <h3 className="text-2xl md:text-3xl font-heading font-bold text-brand-primary mb-6">
                    ...
                    {[
                      ...
                      >
                        <div className="w-8 h-8 rounded-full bg-brand-primary/5 flex items-center justify-center shrink-0 group-hover:bg-brand-primary group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                          <svg
                            className="w-4 h-4 text-brand-primary group-hover:text-brand-gold transition-colors duration-300"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
                        ...
                        <span className="text-gray-800 font-medium group-hover:text-brand-primary transition-colors duration-300">
                          {feature}
                        </span>
                      </li>
                    ))}
                ...
                <div className="w-full lg:w-1/2 grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={i}
                      className={`bg-gradient-to-br ${pkg.color} ${pkg.border} border rounded-2xl p-5 flex flex-col items-center justify-center text-center hover:scale-105 transition-transform duration-300 shadow-sm`}
                    >
                      <span
                        className={`text-sm font-semibold tracking-wider uppercase mb-1 ${pkg.text}`}
                      >
                        {pkg.title}
                      </span>
          ...
          <div className="mb-12">
            ...
            <div className="mt-8 flex justify-center sm:hidden relative z-10">
              <PrimaryButton
                onClick={() => {
                  if (showAllFeatured) {
                ...
                className="bg-[#1F2A44] text-white hover:bg-[#1F2A44]/90 border-transparent shadow-none px-8 py-3 w-full max-w-[200px]"
              >
                ...
                .map((category, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <h4
                          className={`font-heading font-bold text-lg md:text-xl ${isOpen ? "text-brand-primary" : "text-gray-700"}`}
                        >
                          {category}{" "}
                          ...
                          >
                            <div className="px-6 pb-6 pt-2 divide-y divide-gray-50">
                              {categoryServices.map((service, sIdx) => (
                                <div
                                  key={sIdx}
                                  className="py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group lg:hover:bg-gray-50 lg:rounded-xl lg:px-4 lg:-mx-4 transition-colors duration-300"
                                >
                                  <div className="flex-1">
                                    <div className="flex flex-wrap items-center gap-3 mb-2">
                                      <h5 className="font-bold text-[#1F2A44] text-base md:text-lg group-hover:text-brand-gold transition-colors">
                                        {service.title}
                                      </h5>
      ...
      <section className="pt-16 pb-24 bg-brand-cream relative">
        <Container className="relative z-10 max-w-5xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl font-heading font-bold text-brand-primary mb-6">
              Which Therapy is{" "}
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-6">
                      <div
                        className={`p-3 rounded-full transition-all duration-500 group-hover:scale-110 ${isActive ? "bg-brand-primary text-white shadow-md" : "bg-brand-cream text-brand-primary"}`}
                      >
                        {item.icon}
                      </div>
                      <h3
                        className={`text-xl md:text-2xl font-heading font-bold transition-all duration-300 group-hover:translate-x-2 ${isActive ? "text-brand-primary" : "text-brand-primary/80"}`}
                      >
                        {item.title}
                      </h3>
                    </div>
                    <div
                      className={`flex-shrink-0 transition-transform duration-500 ${isActive ? "rotate-45 text-brand-primary" : "text-brand-primary/40 group-hover:text-brand-primary/70"}`}
                    >
                        ...
                        <div className="px-6 pb-8 md:px-10 md:pb-10 pt-0 ml-[4.5rem] md:ml-20">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-2">
                              ...
                              <p className="text-[#1F2A44]/80 text-sm leading-relaxed">
                                {item.forWhom}
                              </p>
                            </div>
                            <div className="space-y-2">
                          ...
                          <div className="mt-6 pt-6 border-t border-gray-200">
                            <span className="text-xs font-semibold uppercase tracking-wider text-brand-primary block mb-2 opacity-80">
