...
import { MapPin, Phone, Mail, User, FileText, Send, Loader2, CheckCircle, AlertCircle } from "lucide-react"
    ...
    <main className="flex flex-col min-h-screen bg-brand-cream overflow-hidden">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-brand-cream via-transparent to-brand-dark/40 opacity-90" />
        </div>
        ...
        <Container className="relative z-10 text-center">
          ...
          <AnimatedReveal direction="up" delay={100}>
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-heading font-bold text-white mb-6 drop-shadow-lg">
              ...
              <span className="italic font-serif text-brand-gold">Holistic Health</span>
            </h1>
          </AnimatedReveal>
        </Container>
      </section>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <AnimatedReveal direction="right" className="h-full">
              <div className="bg-white p-10 md:p-14 rounded-3xl shadow-xl border border-gray-100 h-full flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold tracking-widest uppercase text-brand-gold mb-1">Visit Us</h4>
                      <p className="text-gray-600 leading-relaxed max-w-xs">{siteConfig.address.full}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold tracking-widest uppercase text-brand-gold mb-1">Call Us</h4>
                      <a href={`tel:${siteConfig.contact.phoneRaw}`} className="text-gray-600 hover:text-brand-primary transition-colors text-lg">
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="text-sm font-bold tracking-widest uppercase text-brand-gold mb-1">Email Us</h4>
                      <a href={`mailto:${siteConfig.contact.email}`} className="text-gray-600 hover:text-brand-primary transition-colors text-lg">
      ...
      <section className="pb-24 pt-8 bg-brand-cream relative">
        <Container>
          <AnimatedReveal direction="up" className="max-w-4xl mx-auto">
            <div className="bg-brand-dark rounded-3xl p-8 md:p-14 shadow-2xl relative overflow-hidden">
                ...
                {isSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-gray-300 max-w-md mx-auto mb-8">
                      Thank you for reaching out. Our Ayurvedic experts will get back to you shortly to assist with your journey.
                    </p>
                    <button
                      onClick={() => {
                        setIsSuccess(false)
                  ...
                  <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10">
                    <div className="text-center mb-10">
                      ...
                      <p className="text-brand-sage font-light">Fill out the form below and we will get back to you.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="relative">
                          ...
                          />
                          {errors.name && <p className="text-red-400 text-xs mt-1 absolute -bottom-5"><AlertCircle className="w-3 h-3 inline mr-1"/>{errors.name}</p>}
                        </div>
                        <div className="relative">
                          ...
                          />
                          {errors.email && <p className="text-red-400 text-xs mt-1 absolute -bottom-5"><AlertCircle className="w-3 h-3 inline mr-1"/>{errors.email}</p>}
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                        ...
                        <div className="relative">
                          ...
                          >
                            <option value="" className="bg-brand-dark text-gray-300">Select Treatment</option>
                            {treatments.map((t) => (
                              <option key={t.id} value={t.title} className="bg-brand-dark text-white">{t.title}</option>
                            ))}
                            <option value="General Consultation" className="bg-brand-dark text-white">General Consultation</option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div className="relative mt-2">
                        ...
                        />
                        {errors.message && <p className="text-red-400 text-xs mt-1 absolute -bottom-5"><AlertCircle className="w-3 h-3 inline mr-1"/>{errors.message}</p>}
                      </div>
