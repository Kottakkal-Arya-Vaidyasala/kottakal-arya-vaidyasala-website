...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "In our fast-paced modern world, the ancient therapy of Shirodhara offers unparalleled relaxation for the nervous system.",
    content:
      "Shirodhara, from the Sanskrit words 'Shiro' (head) and 'Dhara' (flow), involves the gentle, continuous pouring of warm medicated oil over the forehead (the 'third eye'). This rhythmic process induces a state of profound mental calmness, akin to deep meditation. It works by regulating the nervous system, reducing cortisol levels, and pacifying the Vata dosha, making it highly effective for chronic stress, insomnia, and anxiety disorders.",
    date: "June 05, 2026",
  ...
  },
  {
    ...
    excerpt:
      "Ayurveda considers digestion (Agni) the cornerstone of health. Learn simple, daily habits to optimize your digestion and boost immunity.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Restore your natural state of health and balance with profound, holistic Homeopathic therapies.",
    content:
